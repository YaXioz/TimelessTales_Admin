                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><?= $action == 'edit' ? 'Edit Timeline Data' : 'Create New Timeline' ?></h4>
                                    <p class="card-description"> Basic form elements </p>
                                    <form class="forms-sample" method="post" action="<?= BASE_URL ?>/timelines/<?= $action ?>" enctype="multipart/form-data">
                                        <?php if ($action == 'edit') : ?>
                                            <input type="hidden" name="id" value="<?= $action == 'edit' ? $timeline->id : '' ?>">
                                        <?php endif ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="year" name="year" value="<?= $action == 'edit' ? htmlspecialchars($timeline->year) : ''; ?>" placeholder="Year">
                                            <?php if (isset($message['year'])): ?>
                                                <div class="form-text text-danger">
                                                    <?= $message['year'] ?>
                                                </div>
                                            <?php endif ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="image_1" class="file-upload-default">
                                        ...
                                        <div class="form-group">
                                            <label>File upload</label>
                                            <input type="file" name="image_2" class="file-upload-default">
                                            <div class="input-group col-xs-12">
                                                <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                                <span class="input-group-append">
                                                    <button class="file-upload-browse btn btn-gradient-primary py-3" type="button">Upload</button>
                                        ...
                                        <div class="form-group">
                                            <label>File upload</label>
                                            <input type="file" name="image_3" class="file-upload-default">
                                            <div class="input-group col-xs-12">
                                                <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Image">
                                                <span class="input-group-append">
                                                    <button class="file-upload-browse btn btn-gradient-primary py-3" type="button">Upload</button>
