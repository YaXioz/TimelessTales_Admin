        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <a href="<?= BASE_URL ?>/timelines/add" class="btn btn-gradient-primary">
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Timeline Data Table</h4>
                    ...
                    <tbody>
                      <?php foreach (
                        ...
                        <tr>
                          ...
                          <td><?php echo htmlspecialchars($timeline->id); ?></td>
                          <td>
                            <?php echo htmlspecialchars($timeline->user_id); ?>
                          </td>
                          <td>
                            <?php echo htmlspecialchars($timeline->year); ?>
                          </td>
                          <td class="py-1">
                            <?php if ($timeline->image_1) : ?>
                              <img
                                src="https://mppsjkhhkmkwzbcxwvwi.supabase.co/storage/v1/object/public/cilukba/<?php echo htmlspecialchars($timeline->image_1); ?>"
                                alt="image" />
                            <?php else : ?>
                          ...
                          <td class="py-1">
                            <?php if ($timeline->image_2) : ?>
                              <img
                                src="https://mppsjkhhkmkwzbcxwvwi.supabase.co/storage/v1/object/public/cilukba/<?php echo htmlspecialchars($timeline->image_2); ?>"
                                alt="image" />
                            <?php else : ?>
                              <img src="<?= BASE_URL ?>/assets/images/faces-clipart/pic-1.png" alt="image">
                            <?php endif ?>
                          ...
                          <td class="py-1">
                            <?php if ($timeline->image_3) : ?>
                              <img
                                src="https://mppsjkhhkmkwzbcxwvwi.supabase.co/storage/v1/object/public/cilukba/<?php echo htmlspecialchars($timeline->image_3); ?>"
                                alt="image" />
                            <?php else : ?>
                              <img src="<?= BASE_URL ?>/assets/images/faces-clipart/pic-1.png" alt="image">
                            <?php endif ?>
                          ...
                          <td>
                            <?php echo htmlspecialchars($timeline->created_at); ?>
                          </td>
                          <td><?php echo htmlspecialchars($timeline->updated_at); ?></td>
                          <td>
                            <div class="d-grid gap-2 d-md-block">
                              <a class="btn btn-outline-warning" href="<?= BASE_URL ?>/timelines/edit/<?= $timeline->id ?>">
                                <i class="fa fa-pencil-square-o"></i>
                              </a>
                              <a class="btn btn-outline-danger" href="<?= BASE_URL ?>/timelines/delete/<?= $timeline->id ?>" onclick="return confirm('Anda yakin ingin menghapus timeline <?= $timeline->id ?>')">
