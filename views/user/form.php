                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title"><?= $action == 'edit' ? 'Edit User Data' : 'Create New User' ?></h4>
                                    <p class="card-description"> Basic form elements </p>
                                    <form class="forms-sample" method="post" action="<?= BASE_URL ?>/users/<?= $action ?>" enctype="multipart/form-data">
                                        <?php if ($action == 'edit') : ?>
                                            <input type="hidden" name="id" value="<?= $action == 'edit' ? $user->id : '' ?>">
                                        <?php endif ?>
                                        <div class="form-group">
                                            <label for="username">Username</label>
                                            <input type="text" class="form-control" id="username" name="username" value="<?= $action == 'edit' ? htmlspecialchars($user->username) : ''; ?>" placeholder="Username">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="email" name="email" value="<?= $action == 'edit' ? htmlspecialchars($user->email) : ''; ?>" placeholder="Email">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="password" name="password" placeholder="<?= $action == 'edit' ? "Only fill for change password" : "Password" ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="<?= $action == 'edit' ? htmlspecialchars($user->name) : ''; ?>" placeholder="Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="bio">Bio</label>
                                            <textarea class="form-control" id="bio" name="bio" rows="3" placeholder="Bio"><?= $action == 'edit' ? htmlspecialchars($user->bio) : ''; ?></textarea>
                                        </div>
                                        <div class="form-group">
