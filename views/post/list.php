        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <a href="<?= BASE_URL ?>/posts/add" class="btn btn-gradient-primary">
                    ...
                    <tbody>
                      <?php foreach (
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo htmlspecialchars($post->timeline_id); ?>
                          </td>
                          <td>
                          ...
                          <td class="py-1">
                            <?php if ($post->image) : ?>
                              <img
                                src="https://mppsjkhhkmkwzbcxwvwi.supabase.co/storage/v1/object/public/cilukba/<?php echo htmlspecialchars($post->image); ?>"
                                alt="image" />
                            <?php else : ?>
                          ...
                          <td>
                            <?php echo htmlspecialchars($post->event_date); ?>
                          </td>
                          <td>
                          ...
                          <td>
                            <div class="d-grid gap-2 d-md-block">
                              <a class="btn btn-outline-warning" href="<?= BASE_URL ?>/posts/edit/<?= $post->id ?>">
                                <i class="fa fa-pencil-square-o"></i>
                              </a>
                              <a class="btn btn-outline-danger" href="<?= BASE_URL ?>/posts/delete/<?= $post->id ?>" onclick="return confirm('Anda yakin ingin menghapus timeline <?= $post->id ?>')">
